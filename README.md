...
- Replace `Irina-Kulish` with your Github username in the [DEMO LINK](https://Irina-Kulish.github.io/react_static-list-of-todos/) and add it to the PR description.
