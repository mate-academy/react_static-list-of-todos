...
A `todos` array is based on the `todosFromServer`, 
 In addition, you have the `Todo` and `User` interfaces already implemented in `./src/types/`. 
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://vanyachyzh.github.io/react_static-list-of-todos/) and add it to the PR description.
