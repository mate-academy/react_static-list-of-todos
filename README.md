...
By using [todos.js](static_todo/src/data/todos.js) and [users.js](static_todo/src/data/users.js) as modules to your React application, create and display a list of all the TODO items. Alongside each item display information about the user it belongs to.
