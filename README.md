...
- Replace `<your_account>` with your Github username in the
  [DEMO LINK](https://kiramarks.github.io/react_static-list-of-todos/)
...
1. Create a `preparedTodos` array of `todos` with a `user` property added to each `todo`. Place it in the `TodoApp.js`
