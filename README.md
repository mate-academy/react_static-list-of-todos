...
- `TodoInfo` takes a `todo` and renders its details, including a `todo.user` with `UserInfo` component if the todo has a user;n
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://MaxShylo.github.io/react_static-list-of-todos/) and add it to the PR description.
